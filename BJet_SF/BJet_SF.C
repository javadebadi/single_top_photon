...
Double_t bJet_SF(Double_t eta, Double_t pt, Int_t jetFalvor, TString OperatingPoint){
	...
	if(pt > 20 && pt <= 10000 && jetFalvor == 1 && op == 0){
		return	0.887973*((1.+(0.0523821*x))/(1.+(0.0460876*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 0 && op == 0){
		return	0.887973*((1.+(0.0523821*x))/(1.+(0.0460876*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 1 && op == 1){
		return	0.561694*((1.+(0.31439*x))/(1.+(0.17756*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 0 && op == 1){
		return	0.561694*((1.+(0.31439*x))/(1.+(0.17756*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 1 && op == 2){
		return	0.817647*((1.+(0.038703*x))/(1.+(0.0312388*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 0 && op == 2){
		return	0.817647*((1.+(0.038703*x))/(1.+(0.0312388*x)));
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 2 && op == 0){
		return	1.13904+-0.000594946*x+1.97303e-06*x*x+-1.38194e-09*x*x*x;
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 2 && op == 1){
		return	1.0589+0.000382569*x+-2.4252e-07*x*x+2.20966e-10*x*x*x;
	}
	if(pt > 20 && pt <= 10000 && jetFalvor == 2 && op == 2){
